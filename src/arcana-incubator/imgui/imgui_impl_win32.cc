...
static void ImGui_ImplWin32_UpdateMousePos()
{
    ...
    if (HWND focused_hwnd = ::GetForegroundWindow())
    {
        ...
        else
        {
            ...
            // the app window.) This is the position you can get with GetCursorPos() + ScreenToClient() or from WM_MOUSEMOVE.
...
static void ImGui_ImplWin32_CreateWindow(ImGuiViewport* viewport)
{
    ...
    data->Hwnd = ::CreateWindowEx(data->DwExStyle, _T("ImGui Platform"), _T("Untitled"), data->DwStyle, // Style, class name, window name
...
static void ImGui_ImplWin32_ShutdownPlatformInterface() { ::UnregisterClass(_T("ImGui Platform"), ::GetModuleHandle(NULL)); }
