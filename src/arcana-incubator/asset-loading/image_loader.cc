...
inc::assets::image_data inc::assets::load_image(const char* filename, inc::assets::image_size& out_size)
{
...
void inc::assets::copy_subdata(const inc::assets::image_data& data, void* dest, unsigned stride, unsigned width, unsigned height)
{
