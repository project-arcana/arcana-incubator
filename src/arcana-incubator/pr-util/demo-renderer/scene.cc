...
void inc::pre::dmr::scene_gpudata::fill_data(tg::isize2 res, tg::pos3 campos, tg::vec3 camforward, unsigned halton_index)
{
...
void inc::pre::dmr::scene::init(pr::Context& ctx, unsigned max_num_instances)
{
...
void inc::pre::dmr::scene::on_next_frame()
{
